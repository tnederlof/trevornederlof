...
Most agentic tools support adding MCPs via a command line argument, json settings files or a settings UI page. [Amp](https://ampcode.com/), my coding agent of choice and has a settings UI in its VS Code extension (figure below) but it is also possible to be set in configuration files or via CLI.

![Managing MCP servers and tools in the Amp VS Code settings](mcp-tools-menu-vscode.png){#fig-mcp-tools-menu fig-align="left" width=800}
