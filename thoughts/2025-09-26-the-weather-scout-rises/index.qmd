...
![Amp using Playwright MCP to troubleshoot and test fixes in UI](playwright-example.png){#fig-playwright fig-align="left" width=800}
...
You can check out the website live now a https://theweatherscout.com
